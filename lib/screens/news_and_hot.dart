...
import 'package:whitemouse_play/widgets/coming_soon_movie_widget.dart';

class NewsAndHotScreen extends StatefulWidget {
  const NewsAndHotScreen({super.key});

  @override
  State<NewsAndHotScreen> createState() => _NewsAndHotScreen();
}

class _NewsAndHotScreen extends State<NewsAndHotScreen> {
  @override
  @override
